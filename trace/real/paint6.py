...
if __name__=='__main__':
	...
	#plt.show()
	fig.savefig("nfake6.eps")


	fig, ax = plt.subplots()

	rects1 = ax.bar(ind, percentageBarratResult, width, yerr=[up,up],hatch="/",color='#AAAAAA',ecolor='k')
	rects2 = ax.bar(ind+width, percentageDarkResult, width, yerr=[up,up],hatch="+",color='#DDDDDD',ecolor='k')
